    ...
    <div class="row">
        ...
        <div class="col-md-2 bg-dark text-white p-0 min-vh-100">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link text-white active" href="/borrow/list">
        ...
        <div class="col-md-10 p-0">
            ...
            <nav class="navbar navbar-light bg-white shadow-sm">
                <div class="container-fluid">
                    <span class="navbar-brand">借阅管理</span>
                    <div class="d-flex">
            ...
            <div class="container-fluid p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-exchange-alt me-2"></i>借阅记录</h2>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${record.actualReturnDate != null}">
                                                <fmt:formatDate value="${record.actualReturnDate}" pattern="yyyy年MM月dd日"/>
                                            </c:if>
                                            <c:if test="${record.actualReturnDate == null}">
                                                -
                                            </c:if>
